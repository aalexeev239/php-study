  ...
  grunt.initConfig({
    ...
    grunticon: {
      mysvg: {
        ...
        options: {
          ...
          defaultHeight: '20px',
          customselectors: {
            'arrow-next': ['.fancybox-next:before'],
            'arrow-prev': ['.fancybox-prev:before'],
            'close'     : ['.fancybox-close:before'],
            'i'         : ['.serv__popup-link:before']
          }
        }
      }
    },
    ...
    watch: {
      ...
      livereload: {
        ...
        files: ['<%= config.src %>/**/*.html','<%= config.src %>/**/*.php','<%= config.src %>/css/**/*.css','<%= config.src %>/js/**/*.js']
      }
    },
